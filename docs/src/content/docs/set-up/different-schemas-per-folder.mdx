...
A grouped entry is still **one** override. It takes a single position in the first-match-wins order above, and if you give it a `name:` it becomes one [collection](/docmeta/reference/configuration/#named-collections), not one per glob.
