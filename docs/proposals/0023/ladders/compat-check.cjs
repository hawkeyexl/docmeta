...
// proposal.3 for `locale`, and kg to proposal.2 for `translation-of`; the
// other five had no part in that and stay where they are. One table so the
// next bump is still a one-line edit.
const VERSIONS = {
